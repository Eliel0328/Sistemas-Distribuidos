...
public class SimpleProxyServer {
    ...
    public static void main(String[] args) throws IOException {
        try {
            ...
            /* CPG */ // argumentos: ip-host-remoto puerto-remoto puerto-local puerto-host-remoto
            ...
            // " on port " + localport);
            System.out.println("Iniciando SimpleProxyServer: " + host + ":" + remoteport + " on port " + localport);
            ...
            /* CPG */ // "<host> <remoteport> <localport>");
                    "<ip-host-remoto> <puerto-servidor-remoto> <puerto-proxy-local> <puerto-servidor-local>");
        }
    }
    ...
    public static void runServer(String host, int remoteport, int localport, int localport2) throws IOException {
        ...
        while (true) {
            ...
            try {
                ...
                /*
                 * try { while((bytes_read = from_server.read(reply)) != -1) {
                 * to_client.write(reply, 0, bytes_read); to_client.flush(); } }
                 * catch(IOException e) {}
                 */
