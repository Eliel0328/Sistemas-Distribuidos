...
public class clienteRMI {
    ...
    public static void main(String[] args) throws Exception {
        ...
        double[][] C4 = r.multiplica_matrices(A2, B1, N);
        double[][] C5 = r.multiplica_matrices(A2, B2, N);
        double[][] C6 = r.multiplica_matrices(A2, B3, N);

        double[][] C7 = r.multiplica_matrices(A3, B1, N);
        double[][] C8 = r.multiplica_matrices(A3, B2, N);
        double[][] C9 = r.multiplica_matrices(A3, B3, N);
